...
ctrHref = trimTrailingSlash('http://www.innenarchitektur-glas.de/'.trim());
ctrHref2 = trimTrailingSlash('http://www.innenarchitektur-glas.de/'.trim());
eInDoc = function(e) {
...
window.onload = function () {
  ...
  linkToHide.innerHTML = '';
    ...
    if (linkfound == false) {
            ...
            div.id = 'error_';
            div.innerHTML = '<a href="http://www.freevisitorcounters.com/en/home/countercode/hashid/?id=6540b56c10dd7920a27a2f9770b92034ef685bf9">Counter Error: Do not change the code. Click here to show the correct code!</a>';
